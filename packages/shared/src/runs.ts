  ...
  readonly difficulties: Readonly<
    Record<
      z.infer<typeof difficultySchema>,
      {
        ...
        /**
         * ДЕЙСТВУЮЩАЯ оплата лутом: константа тира, умноженная на долю
         * уцелевшей разницы уровней. В переросшей зоне уровень врага
         * упирается в потолок диапазона, риск исчезает — и оплата
         * уходит вместе с ним.
         */
        readonly lootMultiplier: number;
        /**
         * Та же оплата БЕЗ затухания. Нужна одному: показать игроку,
         * что число упало не само по себе. Молча урезанная награда
         * читается как поломка, и это уже проверялось на правиле двух
         * аффиксов — спрятать ограничение хуже, чем назвать его.
         */
        readonly lootMultiplierBase: number;
        /**
