...
export type SegmentCard = {
  ...
  /**
   * Множитель силы врагов этого участка.
   *
   * Живёт у участка, а не у зоны: с одним числом на зону трудность
   * внутри неё шла не туда — в одних зонах падала, в других росла.
   */
