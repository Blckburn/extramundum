...
export const playerProfileSchema = z.object({
   ...
   *
   * В публичном профиле, потому что от него зависит вместимость,
   * а вместимость игрок видит на экране снаряжения. Сид драфта
   * и сид кузнеца сюда не входят и не войдут: по ним считается
   * будущее.
   */
  stashTabs: z.int().min(0),
});
